...
public class ManageAdminTest extends TestNGBase {
	...
	public void verifyUserisAbletoAddAdminUsers() throws IOException {
		...
		admin.enterUsernameOnUsernameField(username).enterPasswordOnPasswordField(password)
				.selectUsertypeFromUsertypeField().clickOnSaveButton();
	...
	public void verifyUserisAbleSearchtheAddedAdminUsers() throws IOException {
		...
		// ManageAdminPage admin = new ManageAdminPage(driver);
		admin.clickOnSearchButton().enterUsernameOnSearchField(username).selectUsertypeFromSearchField()
				.clickOnSearch();
